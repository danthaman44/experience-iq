...
from .utils.supabase import Message, create_message, get_messages, get_resume, get_job_description
...
async def handle_chat_data(request: Request, protocol: str = Query('data')):
    ...
    response = StreamingResponse(
        stream_gemini_response(prompt, thread_id, resume[0]["name"], job_description_reference), 
